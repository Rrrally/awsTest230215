<template>
  <div>
    ...
    >
      ...
      <p>
        Wir hosten unsere Website bei AWS. Anbieter ist die Amazon Web Services
        EMEA SARL, 38 Avenue John F. Kennedy, 1855 Luxemburg (nachfolgend AWS).
      </p>
      <p>
      ...
      <p>
        Ralf Olthage Webentwicklung<br />
        2. OG<br />
        Freie-Vogel-Str. 369<br />
        44269 Dortmund
      </p>

      <p>
        Telefon: 0 23 01 - 89 79 69 11<br />
        E-Mail: ralf.olthage@erkundix.de
      </p>
      <p>
      ...
      <p>
        ...
        Netzwerken wie Facebook, Twitter & Co. geteilt werden. Diese Seite nutzt
        dafür das
        <a
          href="https://www.e-recht24.de/erecht24-safe-sharing.html"
          target="_blank"
          rel="noopener noreferrer"
          >eRecht24 Safe Sharing Tool</a
        ...
        Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG dar. Diese Einwilligung
        kann jederzeit mit Wirkung für die Zukunft widerrufen werden.
      </p>
      <p>
        Eine automatische Übertragung von Nutzerdaten an die Betreiber dieser
        ...
        Social-Media-Elemente von Facebook, Twitter & Co. ein
      ...
      <p>
        ...
        in der Europäischen Union entspricht. Bei der Nutzung der
        OpenStreetMap-Karten wird eine Verbindung zu den Servern der
        OpenStreetMap-Foundation hergestellt. Dabei können u. a. Ihre IP-Adresse
        und weitere Informationen über Ihr Verhalten auf dieser Website an die
        OSMF weitergeleitet werden. OpenStreetMap speichert hierzu unter
        Umständen Cookies in Ihrem Browser oder setzt vergleichbare
